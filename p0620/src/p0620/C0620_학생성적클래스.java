...
public class C0620_학생성적클래스 {
	
	int num = 0; // 인스턴스 변수 : 객체선언 후 사용       참조변수명.변수명
	static int n = 0; //클래스 변수 : 객체선언없이 사용    클래스명.변수명
		...
		while(true) {
			...
			case 1:
				while(true) {
					...
					sc[s_count].avg = sc[s_count].total;
					
					//입력완료
					System.out.println("< 학생성적 입력완료 >");
					System.out.printf("%s 학생의 성적이 저장되었습니다.",sc[s_count].name);
					System.out.println();
					s_count++;
